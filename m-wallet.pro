...
QMAKE_CXXFLAGS += -I /opt/local/db-4.8.30.NC/include -L /opt/local/db-4.8.30.NC/lib
...
LIBS += -lssl -lgmp -lcrypto /opt/local/db-4.8.30.NC/lib/libdb_cxx.a $$BDB_LIB_SUFFIX
LIBS += $$OPT_LIBS
